...
#let resume-header(name: "", address: "", contact: "") = {
  set align(center)
  block(text(font: body-font, size: name-size)[#name]) // cleaned trailing comma
  v(6pt)  // must clear Georgia descenders (~5pt below baseline at 18pt)
...
#let section(title, body) = {
  ...
  v(5pt)
  pad(left: 12pt, body) // keep the “inboard” section content look
}
